...
BUILD_DIR=$HOME/build-Ubuntu-18.10
PBUILD_DIR=$HOME/pbuilder/cosmic_result
...
pbuilder-dist cosmic amd64 create --main-only --updates-only ${PB_HTTP_PROXY}
pbuilder-dist cosmic amd64 build ${PB_HTTP_PROXY} ../*dsc
